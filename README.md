...
Buatlah folder Lab3_Web pada root directory web server (C:\xampp\htdocs)
![folder](img/crud.png)
Kemudian untuk mengakses direktory tersebut pada web server dengan mengakses URL: http://localhost/Lab3_Web
![url](img/index.png)
